...
class TblMonitoringTaskSeqOfTestController extends ControllerBase
{
    ...
    public function editAction($uint_monitror_test_mapping_index)
    {
        if (!$this->request->isPost()) {
            ...
            $this->tag->setDefault("uint_job_mapping_index", $tbl_monitoring_task_seq_of_test->uint_job_mapping_index);
            ...
            $this->tag->setDefault("uint_monitor_test_mode", $tbl_monitoring_task_seq_of_test->uint_monitor_test_mode);
            ...
            $this->tag->setDefault("text_monitor_test_description", $tbl_monitoring_task_seq_of_test->text_monitor_test_description);
    ...
    public function createAction()
    {
        ...
        $tbl_monitoring_task_seq_of_test->uint_job_mapping_index = $this->request->getPost("uint_job_mapping_index");
