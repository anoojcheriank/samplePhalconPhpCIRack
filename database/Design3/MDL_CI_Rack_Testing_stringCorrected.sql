...
(
  ...
  text_monitor_test_description text,
...
ALTER TABLE tbl_internal_queue ADD CONSTRAINT fk_uint_job_id
  FOREIGN KEY (uint_job_id) REFERENCES tbl_job_queue (uint_job_id) ON UPDATE RESTRICT;

ALTER TABLE tbl_internal_queue ADD CONSTRAINT fk_uint_slot_index
  FOREIGN KEY (uint_slot_index) REFERENCES tbl_slot_config (uint_slot_index) ON UPDATE RESTRICT;

ALTER TABLE tbl_internal_queue ADD CONSTRAINT fk_uint_test_index
  FOREIGN KEY (uint_test_index) REFERENCES tbl_test (uint_test_index) ON UPDATE RESTRICT;

ALTER TABLE tbl_job_queue ADD CONSTRAINT fk_uint_build_index
  FOREIGN KEY (uint_build_index) REFERENCES tbl_build_details (uint_build_index) ON UPDATE RESTRICT;

ALTER TABLE tbl_monitoring_task_seq_of_test ADD CONSTRAINT fk_monitor_test_index
  FOREIGN KEY (uint_monitor_test_index) REFERENCES tbl_test (uint_test_index) ON UPDATE RESTRICT;

ALTER TABLE tbl_monitoring_task_seq_of_test ADD CONSTRAINT fk_uint_job_mapping_index
  FOREIGN KEY (uint_job_mapping_index) REFERENCES tbl_internal_queue (uint_job_mapping_index) ON UPDATE RESTRICT;

ALTER TABLE tbl_slot_config ADD CONSTRAINT fk_uint_box_index
  FOREIGN KEY (uint_box_index) REFERENCES tbl_box_details (uint_box_index) ON UPDATE RESTRICT;
