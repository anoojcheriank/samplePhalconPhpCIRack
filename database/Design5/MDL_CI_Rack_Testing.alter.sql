...
/* Step #133: Delete column uint_job_status of tbl_job_queue */

ALTER TABLE tbl_job_queue
  DROP uint_job_status;

/* End of Step #133 */

/* Step #134: Delete column uint_number_of_boxes of tbl_job_queue */

ALTER TABLE tbl_job_queue
  DROP uint_number_of_boxes;

/* End of Step #134 */

/* Step #135: New column uint_num_boxes_sced of tbl_job_queue */

ALTER TABLE tbl_job_queue
  ADD uint_num_boxes_sced integer unsigned;

/* End of Step #135 */

/* Step #136: New column uint_num_boxes_inprog of tbl_job_queue */

ALTER TABLE tbl_job_queue
  ADD uint_num_boxes_inprog integer unsigned;

/* End of Step #136 */

/* Step #137: New column uint_num_boxes_finished of tbl_job_queue */

ALTER TABLE tbl_job_queue
  ADD uint_num_boxes_finished integer unsigned;

/* End of Step #137 */

/* Step #138: New column uint_job_status of tbl_job_queue */
...
/* Step #139: Move box of table tbl_internal_queue of DIG_CI_Rack_Testing */

/* THIS STEP DOES NOT GENERATE AN SQL SCRIPT. */

/* End of Step #139 */

/* Step #140: Delete foreign key fk_uint_slot_index of tbl_internal_queue */

ALTER TABLE tbl_internal_queue
  DROP FOREIGN KEY fk_uint_slot_index;

SET @exist := (SELECT count(*) FROM information_schema.statistics WHERE table_name = 'tbl_internal_queue' AND index_name = 'fk_uint_slot_index');
SET @sqlstmt := IF( @exist = 0, 'SELECT ''INFO: Index does not exist.''', 'DROP INDEX fk_uint_slot_index ON tbl_internal_queue');
PREPARE stmt FROM @sqlstmt;
EXECUTE stmt;

/* End of Step #140 */

/* Step #141: Delete column uint_slot_index of tbl_internal_queue */

ALTER TABLE tbl_internal_queue
  DROP uint_slot_index;

/* End of Step #141 */

/* Step #142: Delete column datetime_test_start of tbl_internal_queue */

ALTER TABLE tbl_internal_queue
  DROP datetime_test_start;

/* End of Step #142 */

/* Step #143: Delete column datetime_test_finish of tbl_internal_queue */

ALTER TABLE tbl_internal_queue
  DROP datetime_test_finish;

/* End of Step #143 */

/* Step #144: Delete column uint_test_status of tbl_internal_queue */

ALTER TABLE tbl_internal_queue
  DROP uint_test_status;

/* End of Step #144 */

/* Step #145: Delete column text_error_description of tbl_internal_queue */

ALTER TABLE tbl_internal_queue
  DROP text_error_description;

/* End of Step #145 */

/* Step #146: Delete column datetime_monitor_test_start of tbl_monitoring_task_seq_of_test */

ALTER TABLE tbl_monitoring_task_seq_of_test
  DROP datetime_monitor_test_start;

/* End of Step #146 */

/* Step #147: Delete column datetime_monitor_test_finish of tbl_monitoring_task_seq_of_test */

ALTER TABLE tbl_monitoring_task_seq_of_test
  DROP datetime_monitor_test_finish;

/* End of Step #147 */

/* Step #148: Delete column uint_monitor_test_status of tbl_monitoring_task_seq_of_test */

ALTER TABLE tbl_monitoring_task_seq_of_test
  DROP uint_monitor_test_status;

/* End of Step #148 */

/* Step #149: Delete column text_error_description of tbl_monitoring_task_seq_of_test */
...
/* Step #150: Move box of table tbl_monitoring_task_seq_of_test of DIG_CI_Rack_Testing */

/* THIS STEP DOES NOT GENERATE AN SQL SCRIPT. */

/* End of Step #150 */

/* Step #151: Move box of table tbl_monitoring_task_seq_of_test of DIG_CI_Rack_Testing */

/* THIS STEP DOES NOT GENERATE AN SQL SCRIPT. */

/* End of Step #151 */

/* Step #152: Modify column uint_num_boxes_sced of tbl_job_queue */

/* TODO FOR DBDIFFO USER: uint_num_boxes_sced WAS A NULLABLE COLUMN. SEVERAL ROWS MAY CONTAIN NULL VALUES. YOU MUST SET NON-NULL VALUES FOR THIS COLUMN BEFORE CHANGING IT TO NON-NULLABLE! */

ALTER TABLE tbl_job_queue
  MODIFY uint_num_boxes_sced integer unsigned NOT NULL DEFAULT 0;

/* End of Step #152 */

/* Step #153: Modify column uint_num_boxes_inprog of tbl_job_queue */

/* TODO FOR DBDIFFO USER: uint_num_boxes_inprog WAS A NULLABLE COLUMN. SEVERAL ROWS MAY CONTAIN NULL VALUES. YOU MUST SET NON-NULL VALUES FOR THIS COLUMN BEFORE CHANGING IT TO NON-NULLABLE! */

ALTER TABLE tbl_job_queue
  MODIFY uint_num_boxes_inprog integer unsigned NOT NULL DEFAULT 0;

/* End of Step #153 */

/* Step #154: Modify column uint_num_boxes_finished of tbl_job_queue */

/* TODO FOR DBDIFFO USER: uint_num_boxes_finished WAS A NULLABLE COLUMN. SEVERAL ROWS MAY CONTAIN NULL VALUES. YOU MUST SET NON-NULL VALUES FOR THIS COLUMN BEFORE CHANGING IT TO NON-NULLABLE! */

ALTER TABLE tbl_job_queue
  MODIFY uint_num_boxes_finished integer unsigned NOT NULL DEFAULT 0;

/* End of Step #154 */

/* Step #155: New table tbl_job_execution_status */
...
/* Step #156: Attach table tbl_job_execution_status to DIG_CI_Rack_Testing */

/* THIS STEP DOES NOT GENERATE AN SQL SCRIPT. */

/* End of Step #156 */

/* Step #157: Move box of table tbl_job_execution_status of DIG_CI_Rack_Testing */

/* THIS STEP DOES NOT GENERATE AN SQL SCRIPT. */

/* End of Step #157 */

/* Step #158: Move box of table tbl_job_execution_status of DIG_CI_Rack_Testing */

/* THIS STEP DOES NOT GENERATE AN SQL SCRIPT. */

/* End of Step #158 */

/* Step #159: New foreign key fk_tbl_job_queue_ of tbl_job_queue */

ALTER TABLE tbl_job_queue ADD CONSTRAINT fk_tbl_job_queue_
  FOREIGN KEY (uint_job_id) REFERENCES tbl_job_execution_status (unit_job_execution_status);

/* End of Step #159 */

/* Step #160: Delete foreign key fk_tbl_job_queue_ of tbl_job_queue */
...
/* Step #161: New column uint_job_id of tbl_job_execution_status */

ALTER TABLE tbl_job_execution_status
  ADD uint_job_id integer unsigned NOT NULL DEFAULT 1;

/* End of Step #161 */

/* Step #162: New foreign key fk_uint_job_id_status_tbl of tbl_job_execution_status */
...
/* Step #163: New column uint_slot_index of tbl_job_execution_status */

ALTER TABLE tbl_job_execution_status
  ADD uint_slot_index integer unsigned NOT NULL DEFAULT 1;

/* End of Step #163 */

/* Step #164: New foreign key fk_uint_slot_indextbl_job_execution_status of tbl_job_execution_status */
...
/* Step #165: Move box of table tbl_monitoring_task_seq_of_test of DIG_CI_Rack_Testing */

/* THIS STEP DOES NOT GENERATE AN SQL SCRIPT. */

/* End of Step #165 */

/* Step #166: Move box of table tbl_job_execution_status of DIG_CI_Rack_Testing */

/* THIS STEP DOES NOT GENERATE AN SQL SCRIPT. */

/* End of Step #166 */

/* Step #167: Move box of table tbl_job_execution_status of DIG_CI_Rack_Testing */

/* THIS STEP DOES NOT GENERATE AN SQL SCRIPT. */

/* End of Step #167 */

/* Step #168: Modify column uint_monitor_test_wait of tbl_monitoring_task_seq_of_test */

ALTER TABLE tbl_monitoring_task_seq_of_test
  ADD uint_monitor_test_wait integer unsigned;

/* TODO FOR DBDIFFO USER: MAYBE YOU SHOULD MODIFY THE FOLLOWING COPY SCRIPT TO CONVERT DATA. */

SET SQL_SAFE_UPDATES = 0;

UPDATE tbl_monitoring_task_seq_of_test SET uint_monitor_test_wait = time_monitor_test_wait;
...
ALTER TABLE tbl_monitoring_task_seq_of_test
  DROP time_monitor_test_wait;

/* End of Step #168 */

/* Step #169: Modify column uint_slot_availability of tbl_slot_config */

ALTER TABLE tbl_slot_config
  ADD uint_slot_availability integer unsigned;

/* TODO FOR DBDIFFO USER: MAYBE YOU SHOULD MODIFY THE FOLLOWING COPY SCRIPT TO CONVERT DATA. */

SET SQL_SAFE_UPDATES = 0;

UPDATE tbl_slot_config SET uint_slot_availability = bool_slot_availability;
...
ALTER TABLE tbl_slot_config
  DROP bool_slot_availability;

/* TODO FOR DBDIFFO USER: uint_slot_availability WAS A NULLABLE COLUMN. SEVERAL ROWS MAY CONTAIN NULL VALUES. YOU MUST SET NON-NULL VALUES FOR THIS COLUMN BEFORE CHANGING IT TO NON-NULLABLE! */

ALTER TABLE tbl_slot_config
  MODIFY uint_slot_availability integer unsigned NOT NULL;

/* End of Step #169 */

/* Step #170: New column datetime_test_start of tbl_job_execution_status */
...
/* Step #171: New column datetime_test_finish of tbl_job_execution_status */
...
/* Step #172: New column uint_status of tbl_job_execution_status */

ALTER TABLE tbl_job_execution_status
  ADD uint_status integer unsigned NOT NULL DEFAULT 0;

/* End of Step #172 */

/* Step #173: Modify column uint_execution_status of tbl_job_execution_status */

ALTER TABLE tbl_job_execution_status
  CHANGE uint_status uint_execution_status integer unsigned NOT NULL DEFAULT 0;

/* End of Step #173 */

/* Step #174: New column text_msg of tbl_job_execution_status */
...
/* Step #175: Modify column uint_job_status of tbl_job_queue */

/* TODO FOR DBDIFFO USER: uint_job_status WAS A NULLABLE COLUMN. SEVERAL ROWS MAY CONTAIN NULL VALUES. YOU MUST SET NON-NULL VALUES FOR THIS COLUMN BEFORE CHANGING IT TO NON-NULLABLE! */

ALTER TABLE tbl_job_queue
  MODIFY uint_job_status integer unsigned NOT NULL DEFAULT 0;

/* End of Step #175 */

/* Step #176: Modify column uint_num_boxes_sched of tbl_job_queue */

ALTER TABLE tbl_job_queue
  CHANGE uint_num_boxes_sced uint_num_boxes_sched integer unsigned NOT NULL DEFAULT 0;

/* End of Step #176 */

/* Step #177: Modify column uint_slot_availability of tbl_slot_config */

ALTER TABLE tbl_slot_config
  ALTER uint_slot_availability SET DEFAULT 0;
