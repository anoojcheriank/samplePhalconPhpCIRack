...
class TblInternalQueueController extends ControllerBase
{
    ...
    public function editAction($uint_internalQ_mapping_index)
    {
        if (!$this->request->isPost()) {
            ...
            $this->tag->setDefault("text_error_description", $tbl_internal_queue->text_error_description);
    ...
    public function createAction()
    {
        ...
        $tbl_internal_queue->text_error_description = $this->request->getPost("text_error_description");
