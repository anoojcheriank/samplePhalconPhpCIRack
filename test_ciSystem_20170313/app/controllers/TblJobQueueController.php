...
class TblJobQueueController extends ControllerBase
{
    ...
    public function editAction($uint_job_id)
    {
        if (!$this->request->isPost()) {
            ...
            $this->tag->setDefault("uint_num_boxes_sched", $tbl_job_queue->uint_num_boxes_sched);
            $this->tag->setDefault("uint_num_boxes_inprog", $tbl_job_queue->uint_num_boxes_inprog);
            $this->tag->setDefault("uint_num_boxes_finished", $tbl_job_queue->uint_num_boxes_finished);
    ...
    public function createAction()
    {
        ...
        $tbl_job_queue->uint_job_id = $this->request->getPost("uint_job_id");
        ...
        $tbl_job_queue->uint_num_boxes_sched = $this->request->getPost("uint_num_boxes_sched");
        $tbl_job_queue->uint_num_boxes_inprog = $this->request->getPost("uint_num_boxes_inprog");
        $tbl_job_queue->uint_num_boxes_finished = $this->request->getPost("uint_num_boxes_finished");
