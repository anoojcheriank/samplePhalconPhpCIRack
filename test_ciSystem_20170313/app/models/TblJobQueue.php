...
class TblJobQueue extends \Phalcon\Mvc\Model
{
     ...
     * @Column(type="integer", length=10, nullable=false)
     */
    public $uint_num_boxes_finished;
    ...
    public function initialize()
    {
        ...
        $this->hasMany('uint_job_id', 'TblJobExecutionStatus', 'uint_job_id', ['alias' => 'TblJobExecutionStatus']);
